...
public class ObjectFactory {
    ...
    private final static QName _IllegalRequestParameterException_QNAME = new QName("http://impl.ws.itmo/", "IllegalRequestParameterException");
    ...
    private final static QName _PostgreSqlException_QNAME = new QName("http://impl.ws.itmo/", "PostgreSqlException");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://impl.ws.itmo/", name = "IllegalRequestParameterException")
    public JAXBElement<CatServiceFault> createIllegalRequestParameterException(CatServiceFault value) {
        return new JAXBElement<CatServiceFault>(_IllegalRequestParameterException_QNAME, CatServiceFault.class, null, value);
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://impl.ws.itmo/", name = "PostgreSqlException")
    public JAXBElement<CatServiceFault> createPostgreSqlException(CatServiceFault value) {
        return new JAXBElement<CatServiceFault>(_PostgreSqlException_QNAME, CatServiceFault.class, null, value);
    }
